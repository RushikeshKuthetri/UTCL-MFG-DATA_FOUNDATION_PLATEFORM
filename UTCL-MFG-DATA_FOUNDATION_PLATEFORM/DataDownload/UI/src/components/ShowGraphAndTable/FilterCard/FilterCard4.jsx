...
export const FilterCard4 = ({ showingInTrend, data }) => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full rounded-xl border border-[var(--form-border)] p-2 mt-2">
        ...
        <div className="grid gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div
              className="w-full h-[35px] rounded-md border border-[var(--form-border)]
      flex items-center px-1 cursor-pointer
      bg-[var(--input-enable-bg)] text-[var(--text-color)]"
      ...
      bg-[var(--input-enable-bg)] text-[var(--text-color)]"
            >
              ...
              <span className="text-sm font-medium whitespace-nowrap">
                {tagSelected.length > 0
                  ? `${tagSelected.length} ${tagSelected.length === 1 ? "tag is selected" : "tags are selected"
                  }`
                  : "No tags selected"}
              </span>
      ...
      bg-[var(--input-enable-bg)] text-[var(--card-subtle)]"
            >
        ...
        <div className="grid gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="w-full h-[35px] rounded-md border border-[var(--form-border)] overflow-hidden flex items-center">
              <DatePicker
      ...
      ${!showingInTrend && sectionDropDisable
                    ? "bg-[var(--input-disable-bg)] cursor-not-allowed"
                    : "bg-[var(--input-enable-bg)]"
                  }
      ${validationErrorMsg1.startDate ? "border-red-500" : "border-none"}
      text-[var(--text-color)]
    `}
                showTimeSelect
                dateFormat="d/MM/yyyy h:mm aa"
            ...
            {validationErrorMsg1.startDate && (
              <p className="text-sm text-red-500">
                <InputValidationText validationMessage={validationErrorMsg1.startDate} />
              </p>
            )}
          </div>
      ...
      ${validationErrorMsg1.endDate ? "border-red-500" : "border-none"}
      text-[var(--text-color)]
    `}
                showTimeSelect
                dateFormat="d/MM/yyyy h:mm aa"
            ...
            {validationErrorMsg1.endDate && (
              <p className="text-sm text-red-500">
                <InputValidationText validationMessage={validationErrorMsg1.endDate} />
              </p>
            )}
          </div>
        ...
        <div className="flex justify-center mt-2 mb-2">
          <button
            onClick={downloadHandler}
            disabled={userStatus.loading}
            className="h-[32px] w-[120px] shrink-0 cursor-pointer px-2 rounded-md bg-[var(--submit-button-bg)] hover:bg-[var(--submit-button-hover-bg)] text-[#111111] text-[14px] font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
