  ...
  const alertCard = (val, index) => {
    ...
    "/>
        ...
        <div className="flex justify-center gap-4 mt-2">
          ...
          <button
            className="px-4 py-1.5 rounded-md border text-red-500 border-[var(--button-border)] bg-[var(--button-bg)] hover:bg-[var(--button-hover-bg)] font-medium transition disabled:opacity-50"
            disabled={!cardValues[val].id}
            onClick={() => {
              // let tempPlantVlaues = [...selectedPlantVlaues];
              // tempPlantVlaues = tempPlantVlaues.filter(
